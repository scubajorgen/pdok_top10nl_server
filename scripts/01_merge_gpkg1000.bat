...
ogr2ogr         -f GPKG -select type_functioneel_gebied,soortnaam,nederlandse_naam ..\maps\merged_gpkg\merge1000.gpkg ..\maps\gpkg\top1000nl_Compleet.gpkg top1000nl_functioneel_gebied_punt
echo 2 - Gebouw
...
ogr2ogr -update -f GPKG -select naam,type_element,soortnaam ..\maps\merged_gpkg\merge1000.gpkg ..\maps\gpkg\top1000nl_Compleet.gpkg top1000nl_inrichtingselement_lijn
echo 6 - Plaats
ogr2ogr -update -f GPKG -select nederlandse_naam,naam_officieel,type_gebied,aantal_inwoners ..\maps\merged_gpkg\merge1000.gpkg ..\maps\gpkg\top1000nl_Compleet.gpkg top1000nl_plaats_punt
ogr2ogr -update -f GPKG -select nederlandse_naam,naam_officieel,type_gebied,aantal_inwoners ..\maps\merged_gpkg\merge1000.gpkg ..\maps\gpkg\top1000nl_Compleet.gpkg top1000nl_plaats_vlak
echo 7 - Plantopografie
REM Missing!
REM ogr2ogr -update -f GPKG -select typeobject,naam ..\maps\merged_gpkg\merge1000.gpkg ..\maps\gpkg\top1000nl_Compleet.gpkg top1000nl_plantopografie_vlak
echo 8 - RegistratiefGebied
ogr2ogr -update -f GPKG -select nederlandse_naam,naam_officieel,nummer,type_regigebied ..\maps\merged_gpkg\merge1000.gpkg ..\maps\gpkg\top1000nl_Compleet.gpkg top1000nl_registratief_gebied_vlak
echo 9 - Relief
echo 10 - Spoorbaandeel
ogr2ogr -update -f GPKG -select elektrificatie,fysiekvoorkomen,spoorbreedte,status,type_infrastructuur,type_spoorbaan,vervoerfunctie,brugnaam,tunnelnaam,baanvaknaam,aantal_sporen ..\maps\merged_gpkg\merge1000.gpkg ..\maps\gpkg\top1000nl_Compleet.gpkg top1000nl_spoorbaandeel_lijn
echo 11 - Terrein
ogr2ogr -update -f GPKG -select naam,type_landgebruik,voorkomen ..\maps\merged_gpkg\merge1000.gpkg ..\maps\gpkg\top1000nl_Compleet.gpkg top1000nl_terrein_vlak
echo 12 - Waterdeel
